...
test_that("bain.default works", {
  expect_equal(bain_res$fit[1,],
               c(Fit_eq = 1, Fit_in = 0.425272985864483, Com_eq = 1, Com_in = 0.164505790338879,
                   Fit = 0.425272985864483, Complexity = 0.164505790338879, BF = 3.758,
                   PMPa = 1, PMPb = 0.72107204094751), tolerance = .01)
})

test_that("bain.default returns the same as Bain", {
  bain_result <- unname(bain_res$fit[1,])
