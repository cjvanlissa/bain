...
a) A vector containing estimates of the
parameters used to specify `hypotheses` possibly augmented with the
...
contain eight means (four for each group), `group_parameters = 4`
...
factor.
c) Bayesian multiple regression
